                   ...
                   <h1> Shipping methods</h1>
                    <div className="block">
                        <div className="basket1">
                            <h2> <SlBasket/> Pickup from the store</h2>
                        ...
                        <div className="basket2">
                            <h2><BsTruck/> Delivery by courier in Bishkek</h2>
                    ...
                    <div className="block2">
                        <div className="basket3">
                            <h2><TbPlayerTrackNext/> Points of delivery of orders</h2>
                        ...
                        <div className="basket4">
                            <h2><AiOutlineMail/> Delivery in the Kyrgyz region and throughout the CIS</h2>
